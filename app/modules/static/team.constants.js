        ...
        },
        {
            ...
            members: [
                ...
                },
                {
                    ...
                    slug: 'cam-allen',
                    bio: [
                        'Responsible for building the Zooniverse\'s API infrastructure. Cam considers himself a music and fine wine connoisseur - others do not. In his space time he enjoys playing an obscure form of rugby.'
                    ]
                },
                {
                    name: 'Greg Hines',
                    slug: 'greg-hines',
                    bio: [
                        'Greg uses machine learning and statistics to help projects analyse the volunteer classifications. He has a PhD in Computer Science from the University of Waterloo, Canada. In his spare time, Greg loves to eat pancakes with real maple syrup and run ultramarathons.'
                    ]
                },
                {
                    name: 'Roger Hutchings',
                    slug: 'roger-hutchings',
                    bio: [
